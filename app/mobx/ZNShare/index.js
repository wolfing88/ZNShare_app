/**
 * @flow
 * Created by kwon on 2018/8/6.
 */

import {observable, computed, action, runInAction, autorun} from 'mobx';
import {ConfigStore} from '../../store/ConfigStore';
import {Response} from 'react-native-image-picker';
import {fetchUpLoadToken, upLoadImage, fetchSearchDetail} from '../../servers/ZNShare';
import RNFetchBlob from 'rn-fetch-blob';



class ZNShareMobx extends ConfigStore {
	...
	uploadImage = async (response: Response) => {
		...
		// response = {
		// 	uri: 'file:///Users/kwon/Library/Developer/CoreSimulator/Devices/BB817212-9896-4E20-A8F6-221489895E53/data/Containers/Data/Application/93925139-4818-4043-8407-1B900076BA09/Documents/ZNShare/DEC950B5-DBFE-45A4-A821-5FC8886A6585.jpg'
		// };
